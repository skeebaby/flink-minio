...
public class demo {
    public static void main(String[] args) throws Exception {
        try {
             ...
             */
            minioClient.putObject("filedir","sample.txt", "/Users/leiliang/Data/origSample.txt");

            //第四步：调用statObject()来判断对象(文件)是否存在
            ObjectStat objectStat=minioClient.statObject("filedir", "sample.txt");
            if(objectStat!=null){
             ...
             */
            minioClient.getObject("filedir", "sample.txt", "/Users/leiliang/Data/newSample.txt");
